...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 28 fév. 2024 à 16:13
...
CREATE TABLE `actualites` (
  ...
  `id_tags` int(11) NOT NULL COMMENT 'id des tags de l''actu',
